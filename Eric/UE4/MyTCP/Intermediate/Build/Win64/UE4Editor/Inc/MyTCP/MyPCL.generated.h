...
#define MyTCP_Source_MyTCP_MyPCL_h_15_RPC_WRAPPERS \
 ...
 \
	DECLARE_FUNCTION(execGetColorTextureData) \
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(TArray<FColor>*)Z_Param__Result=this->GetColorTextureData(); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execGetPosTextureData) \
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(TArray<FColor>*)Z_Param__Result=this->GetPosTextureData(); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	...
	{ \
		...
		P_GET_PROPERTY(UIntProperty,Z_Param_PacketSize); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=this->StartTCPReceiver(Z_Param_SocketName,Z_Param_TheIP,Z_Param_ThePort,Z_Param_PacketSize); \
		P_NATIVE_END; \
	}
