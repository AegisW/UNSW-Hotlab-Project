...
// Cross Module References
	MYTCP_API UFunction* Z_Construct_UFunction_AMyPCL_GetColorTextureData();
	MYTCP_API UClass* Z_Construct_UClass_AMyPCL();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FColor();
	MYTCP_API UFunction* Z_Construct_UFunction_AMyPCL_GetPosTextureData();
...
// End Cross Module References
	...
	void AMyPCL::StaticRegisterNativesAMyPCL()
	{
		...
		static const TNameNativePtrPair<ANSICHAR> AnsiFuncs[] = {
			{ "GetColorTextureData", (Native)&AMyPCL::execGetColorTextureData },
			{ "GetPosTextureData", (Native)&AMyPCL::execGetPosTextureData },
			{ "OnTextureUpdated", (Native)&AMyPCL::execOnTextureUpdated },
			{ "StartTCPReceiver", (Native)&AMyPCL::execStartTCPReceiver },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, AnsiFuncs, ARRAY_COUNT(AnsiFuncs));
	}
	UFunction* Z_Construct_UFunction_AMyPCL_GetColorTextureData()
	{
		struct MyPCL_eventGetColorTextureData_Parms
		{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("GetColorTextureData"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x04020401, 65535, sizeof(MyPCL_eventGetColorTextureData_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(ReturnValue, MyPCL_eventGetColorTextureData_Parms), 0x0010000000000580);
			UProperty* NewProp_ReturnValue_Inner = new(EC_InternalUseOnlyConstructor, NewProp_ReturnValue, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FColor());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Texture"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("MyPCL.h"));
#endif
		}
		return ReturnFunction;
	}
	UFunction* Z_Construct_UFunction_AMyPCL_GetPosTextureData()
	{
		struct MyPCL_eventGetPosTextureData_Parms
		{
			TArray<FColor> ReturnValue;
		};
		UObject* Outer = Z_Construct_UClass_AMyPCL();
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("GetPosTextureData"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x04020401, 65535, sizeof(MyPCL_eventGetPosTextureData_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(ReturnValue, MyPCL_eventGetPosTextureData_Parms), 0x0010000000000580);
			UProperty* NewProp_ReturnValue_Inner = new(EC_InternalUseOnlyConstructor, NewProp_ReturnValue, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FColor());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
	...
	UFunction* Z_Construct_UFunction_AMyPCL_StartTCPReceiver()
	{
		...
		if (!ReturnFunction)
		{
			...
			UProperty* NewProp_PacketSize = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("PacketSize"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(PacketSize, MyPCL_eventStartTCPReceiver_Parms), 0x0010000000000082);
			...
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("MyPCL.h"));
			MetaData->SetValue(NewProp_PacketSize, TEXT("NativeConst"), TEXT(""));
	...
	UClass* Z_Construct_UClass_AMyPCL()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->LinkChild(Z_Construct_UFunction_AMyPCL_GetColorTextureData());
				OuterClass->LinkChild(Z_Construct_UFunction_AMyPCL_GetPosTextureData());
				...
				UProperty* NewProp_ColorZeroRatio = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ColorZeroRatio"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ColorZeroRatio, AMyPCL), 0x0010000000000001);
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_AMyPCL_GetColorTextureData(), "GetColorTextureData"); // 77337762
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_AMyPCL_GetPosTextureData(), "GetPosTextureData"); // 3068945301
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_AMyPCL_StartTCPReceiver(), "StartTCPReceiver"); // 1277199194
				...
				MetaData->SetValue(NewProp_ColorZeroRatio, TEXT("Category"), TEXT("Debug"));
				MetaData->SetValue(NewProp_ColorZeroRatio, TEXT("ModuleRelativePath"), TEXT("MyPCL.h"));
	...
	IMPLEMENT_CLASS(AMyPCL, 601781167);
